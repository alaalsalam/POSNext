...
- The user sees a live **Preview** (an iframe rendering `/desk` and its sub-routes), a read-only
...
- After ANY change that should be visible, run **`bench build --app pos_next`**. The preview only
