<template>
	<div class="sticky top-0 z-[200] border-b border-emerald-100 bg-white/95 shadow-sm backdrop-blur">
			...
			<div class="w-16 flex-shrink-0 flex items-center justify-center">
				...
				>
					...
					<svg class="h-6 w-6" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
						...
						<rect x="13" y="43" width="74" height="14" rx="7" fill="#ffffff" />
						<rect x="13" y="66" width="55" height="14" rx="7" fill="#ffffff" />
					</svg>
				</button>
			</div>
			...
			>
				...
				<div class="flex items-center gap-1 sm:gap-4 min-w-0 flex-1 overflow-hidden">
					<div class="min-w-0 flex-shrink overflow-hidden">
						...
						<p
							v-if="profileName"
							class="mt-0.5 hidden truncate text-[9px] text-emerald-700 sm:block sm:text-xs"
						>
							{{ profileName }}
						</p>
					</div>
