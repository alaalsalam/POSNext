const ARABIC_TO_ENGLISH = {
	...
	"من تاريخ": "From Date",
	// Classic catalog (items) screen
	"شاشة الأصناف": "Items Screen",
	"إدارة الأصناف — إضافة وتعديل وحذف": "Manage items — add, edit and delete",
	حفظ: "Save",
	"جارٍ الحفظ...": "Saving...",
	حذف: "Delete",
	بحث: "Search",
	تحديث: "Refresh",
	"أول صنف": "First item",
	"الصنف السابق": "Previous item",
	"الصنف التالي": "Next item",
	"آخر صنف": "Last item",
	"بحث بالاسم أو الكود أو الباركود": "Search by name, code or barcode",
	"كود الصنف": "Item Code",
	تلقائي: "Auto",
	"اسم الصنف": "Item Name",
	الباركود: "Barcode",
	...
	"اسم المجموعة الجديدة": "New group name",
	"وحدة الصنف": "Item UOM",
	السريال: "Serial",
	...
	"أدخل سعر تكلفة للكمية المضافة": "Enter a cost price for the added quantity",
	"تم حفظ الصنف {0}": "Item {0} saved",
	"حذف الصنف {0}؟": "Delete item {0}?",
	"تم حذف الصنف": "Item deleted",
	"تم تعطيل الصنف": "Item disabled",
	"تمت إضافة المجموعة": "Group added",
